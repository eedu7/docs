...
import {
    ...
    BoldIcon,
    ChevronDownIcon, HighlighterIcon, ImageIcon,
    ItalicIcon, Link2Icon, ListCollapseIcon, ListIcon, ListOrderedIcon,
    ListTodoIcon,
    LucideIcon,
    MessageSquarePlusIcon, MinusIcon, PlusIcon,
    PrinterIcon,
    Redo2Icon,
    RemoveFormattingIcon, SearchIcon,
    SpellCheckIcon,
    UnderlineIcon,
...
const ListButton = () => {
    ...
    const lists: {label: string, icon: LucideIcon, isActive: () => boolean | undefined, onClick?: () => void}[] = [
        {
            label: "Bullet List",
            icon: ListIcon,
