...
const FontFamilyButton = () => {
    ...
    const fonts: { label: string, value: string }[] = [{label: "Arial", value: "Arial"}, {
        label: "Arial Black",
        value: "Arial Black"
    }, {label: "Verdana", value: "Verdana"}, {label: "Tahoma", value: "Tahoma"}, {
        label: "Trebuchet MS",
        value: "Trebuchet MS"
    }, {label: "Impact", value: "Impact"}, {label: "Times New Roman", value: "Times New Roman"}, {
        label: "Georgia",
        value: "Georgia"
        ...
        label: "Candara",
        value: "Candara"
    }, {label: "Consolas", value: "Consolas"}, {label: "Copperplate", value: "Copperplate"}, {
        label: "Futura",
        value: "Futura"
    }, {label: "Geneva", value: "Geneva"}, {label: "Rockwell", value: "Rockwell"}, {
        label: "Segoe UI",
        value: "Segoe UI"
    }, {label: "Perpetua", value: "Perpetua"}, {label: "Monaco", value: "Monaco"}];
